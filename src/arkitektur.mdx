...
Egendata består i dagsläget av fyra delar:

* **Egendata-appen:** En mobilapplikation där användaren styr tillgång till data och där användarens nycklar lagras.

* **PDS (Personal Data Store):** En lagringsyta för data. All information är krypterad på ett sådant sätt att PDS:en inte ska behöva vara säker för att användardatat ska anses skyddat.

* **Tjänst:** En sajt eller applikation som använder sig av Egendata för att läsa/skriva information.

* **Operator:** Servrar som kopplar samman Tjänster med PDS:er för att möjliggöra läsning, skrivning och andra uppdateringar.

Vi ser redan nu att ytterligare delar kan behöva komma på plats. Ett exempel är:

* **Serviceregister:** Här registreras Tjänster så att användare enklare kan hitta dem. Vi misstänker även att denna del behövs för att möjliggöra fler än en Operator.
